...
const {prototype: {toString: toString$2}} = Object;
...
const { Generators: Generators$2 } = new Library();

const AsyncFunction$1 = Object.getPrototypeOf(async function() {}).constructor;
const GeneratorFunction$1 = Object.getPrototypeOf(function*() {}).constructor;
const AsyncGeneratorFunction$1 = Object.getPrototypeOf(async function*() {})
  .constructor;
...
function toDOMFragment(text, filePath, callback) {
